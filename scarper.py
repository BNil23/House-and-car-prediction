...
class Scraper:
    ...
    def get_info(self, url):
        ...
        # # eğer iterasyondaki sütun, masterda varsa özelliğe karşılık gelen değeri listeye atsın, yoksa bilinmiyor
        #
        #     if self.columns[x] in master:
        #         master_new.append(master[i + 1])
        #         i += 2
        #     else:
        #         master_new.append('Bilinmiyor')
